...
----------------------------
**WildlifeTag Automator** is an unofficial, independent, open-source tool. This project is licensed under the **GNU General Public License v3.0**, see the [LICENSE](LICENSE) for details.
